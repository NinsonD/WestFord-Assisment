...
const CoursePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex justify-center items-center flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="flex-1">
              ...
              <div className="max-w-4xl text-base font-light text-black leading-6 space-y-6">
                <p>
                  ...
                  in Software Engineering is a comprehensive program designed to equip students with
                  the knowledge, skills, and practical experience needed to excel in the dynamic
                  field of software development. This program focuses on preparing students for
                  careers in designing, building, and maintaining software applications that meet
                  modern technological and business demands.
                </p>
                <p>
            ...
            <div className="w-full lg:w-96 flex-shrink-0">
              <div className="relative bg-white rounded-[25px] shadow-lg p-8">
                <img
                  src="/images/img_rectangle_87.svg"
                  alt="background"
                  className="absolute inset-0 w-full h-full object-cover rounded-[25px] opacity-20 pointer-events-none"
                />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-base font-light text-black leading-6 mb-8">
                Graduates of the Higher National Diploma International (HND) in Computing (Software
                Engineering) are well-equipped to pursue a wide range of job opportunities in the
                dynamic field of software development. The skills gained through this program open
                doors to various roles across industries that rely on technology and software
                solutions.
              </p>
      ...
      <section className="py-16 bg-[#0c2d46]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-medium mb-8">
          ...
          <p className="text-base font-light text-white leading-6 max-w-4xl">
            ...
            various backgrounds and aspirations, making it suitable for High School Graduates, Tech
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          ...
          <div>
            ...
            <p className="text-base font-light text-black leading-6 max-w-6xl">
              Pearson Education is a British-owned educational publishing and appraisal service for
              educational institutions and corporations, as for students directly. It integrates
              world-class educational content and evaluation, driven by services and technology, to
              allow more efficient teaching and customized learning. Their mission is to have a
              direct partnership with millions of lifelong learners and to link education to the way
              people aspire to live and work each day. They assume that wherever learning
              flourishes, people do as well.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex items-center justify-center mt-12">
            <div className="flex items-center space-x-4">
              ...
              <div className="bg-[#879da5] rounded-full w-5 h-5 flex items-center justify-center">
                <img src="/images/img_vector_black_900_8x21.svg" alt="arrow" className="w-2 h-5" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="bg-[#0c2d46] rounded-[25px] p-8 relative">
                <div className="bg-white rounded-t-[18px] p-8 mb-6">
                  <img src="/images/img_pearson.png" alt="Pearson" className="h-16 w-55 mx-auto" />
                </div>
                  ...
                  <div key={index}>
                    ...
                    >
                      ...
                      <img
                        ...
                        alt="expand"
                        className={`w-4 h-4 mr-4 md:mr-12 transition-transform ${expandedSection === category ? 'rotate-180' : ''}`}
                      />
                    </div>
